Public Class RptCreditosVencidos
    Public CFecha As Date
    Private Sub RptCreditosVencidos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Else
            MsgBox("No hay ningun Credito Vencido para mostrar")
            Close()
        End If
    End Sub
End Class