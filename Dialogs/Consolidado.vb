Public Class Consolidado
    ...
    Private Sub Consolidado_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        GestionView.Table = MainDSO.Gestion
        Dim f As String = ""
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If view.Count > 0 And k Then
            Dim row As MainDS.RptConsolidadoRow = MainDSO.RptConsolidado.NewRow
            row.SociosM = 0
            row.SociosF = 0
            row.CAPS = 0
            row.TotalCreditos = 0
            ...
            For Each r As DataRowView In view
                row.SociosM += r("NTSM") - r("NTSMR")
                row.SociosF += r("NTSF") - r("NTSFR")
                row.CAPS += r("ZVC") - r("ZLC")
                row.TotalCreditos += r("qCON") + r("qCOR")
                row.MontoCreditos += r("ZCON") + r("ZCOR")
                row.Ganancias += r("ZGestionMNeto")
            ...
            For Each x As Object In bankos
                Debug.WriteLine(x)
            Next
            MainDSO.RptConsolidado.Rows.Clear()
            MainDSO.RptConsolidado.Rows.Add(row)
